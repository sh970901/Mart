 ...
 * @param <T>
 */
public final class FastStack<T> extends ArrayList<T> {
     ...
     */
    public FastStack(final Collection<T> collection) {
        super(collection);
    }
     ...
     * <tt>o</tt> occurs as an item in this stack, this method returns the distance
     * from the top of the stack of the occurrence nearest the top of the stack; the
     * topmost item on the stack is considered to be at distance <tt>1</tt>. The
