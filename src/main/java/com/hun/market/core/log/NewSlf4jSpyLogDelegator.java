package com.dalgona.framework.tools;
 ...
 */
public class NewSlf4jSpyLogDelegator implements SpyLogDelegator {
    /**
     * Create a SpyLogDelegator specific to the Simple Logging Facade for Java (slf4j).
     */
    public NewSlf4jSpyLogDelegator() {}
        ...
        if (sqlTimingLogger.isErrorEnabled() &&
            ...
            if (Properties.isSqlTimingErrorThresholdEnabled() &&
                ...
                if (Properties.isSqlTimingWarnThresholdEnabled() &&
                    ...
                    //String newSql = buildSqlTimingDump(spy, execTime, methodCall, sql, false);
                    //if (newSql != null) {
     ...
     */
    public String buildSqlTimingDump(Spy spy, long execTime, String methodCall,
    ...
    public void resultSetCollected(ResultSetCollector resultSetCollector) {
        String resultsToPrint = new ResultSetCollectorPrinter2().getResultSetToPrint(resultSetCollector);
        resultSetTableLogger.info(resultsToPrint);
    }

    class ResultSetCollectorPrinter2 extends ResultSetCollectorPrinter {
         ...
         * Default constructor
         */
        public ResultSetCollectorPrinter2() {
        ...
        public String getResultSetToPrint(ResultSetCollector resultSetCollector) {
            ...
            if(count > 50) {
                this.table.append("출력 행이 너무 많아요. 생략합니다. total=" + resultSetCollector.getRows().size());
                this.table.append(System.getProperty("line.separator"));
            }
